...
const MemoizedChild = memo(function Child({ onClick }) {
  ...
  return (
    <div>
      ...
      <p>if you click the "toggle unrelated state" button, watch the console. I won't re-render! Because useCallback protected my onClick prop.</p>
