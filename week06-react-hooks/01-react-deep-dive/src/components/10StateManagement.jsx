...
export default function StateManagement() {
  ...
  return (
    <div className="card">
      <h2>10. State Management Basics</h2>
      ...
      >
        ...
        <p>
          the parent holds the state. it passes state DOWN as props, and passes
          the setter DOWN as props.
        </p>
      ...
      <div className="wrong-example card">
        ...
        <p>
          if the child creates the state, the parent can never access it or pass
          it to a sibling!
        </p>
        <BadChildComponent />
      </div>
