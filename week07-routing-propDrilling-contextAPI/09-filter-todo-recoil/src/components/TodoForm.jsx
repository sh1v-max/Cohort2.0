...
export default function TodoForm() {
  ...
  return (
    <form className="flex flex-col sm:flex-row gap-3 mb-6" onSubmit={addItem}>
      ...
      />
      <button type="submit" className="inline-flex items-center justify-center gap-2 px-6 py-3 font-semibold text-white bg-indigo-500 border border-transparent rounded-xl cursor-pointer transition-all hover:bg-indigo-600 hover:-translate-y-0.5 active:translate-y-0 focus:outline-none focus:ring-4 focus:ring-indigo-500/30">
        <Plus size={20} />
        Add Task
      </button>
    </form>
